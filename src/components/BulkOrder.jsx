const BulkOrder = () => {
    return (
        <div className="xl:py-32 py-10 xl:px-[165px] px-4 flex flex-col-reverse xl:flex-row gap-8 items-center">
            <div className="flex flex-col gap-2">
                ...
                <ul className="flex flex-col gap-6 mb-10  xl:text-2xl text-sm">
                    ...
                    <li className="font-bold flex gap-2">
                        ...
                        <div className="">
                            ...
                            <p className="text-accent text-base font-normal">*Syarat & ketentuan berlaku</p>
                        </div>   
                    </li>
                </ul>
                <button className="px-8 py-5 text-white bg-primary rounded-xl xl:self-start font-bold">Pesan Sekarang</button>
            </div>
            <img src="/images/bulk-order.png" alt="" />
        </div>
    );
}
